...
/*
 ** Read Analog TDS sensor
 **Overview you can read in link: https://www.dfrobot.com/product-1662.html
 */
 ...
 **Overview you can read in link: https://www.dfrobot.com/product-1394.html
 */
 ...
 **Overview you can read in link: https://www.dfrobot.com/product-1782.html
 */
...
//Sending payload from Slave to MasterNode
void SendMessLora_to_Master(float avgTemp, float tdsValue, float avg_volt_TDS, int readIndex, float ntuValue, float avg_volt_Turbidity, float phValue, float avg_volt_pH)
{
  ...
  inString = "";
// Check code Reciver from Master node
